# S - Principio da Responsabilidade Unica (SRP)
""""
Um modulo deve ter um, e apenas um, motivo para alteracao

Um modulo deve ser especializado em um unico assunto e possuir apenas uma unica responsabilidade dentro do seu software
"""
